" Nim indent script
" Based on the upstream nim.vim indent logic, used standalone to avoid
" ftplugin-side compiler checks on environments where host `nim` is absent.
...
function! GetNimIndent(lnum)
  ...
  " if we got here, this should be the beginning of a multi-line expression
